<template>
    ...
    <section id="projects">
        ...
        <div class="projects-grid">
            <div v-for="(project, index) in projects" :key="index" class="project-card">
                ...
                <a v-if="project.githubLink !== null && project.githubLink !== ''" class="project-link" :href="`${project.githubLink}`" target="_blank">GitHub</a>
    ...
    <section id="contact">
        ...
        <div class="contact-item">
            ...
            <span>e-mail: devpedrobarbosa@gmail.com</span>
        </div>
        <div class="contact-item">
            <span class="console-prefix">$</span>
            <span>github:
...
<script>
import script from '../scripts/home.js'
